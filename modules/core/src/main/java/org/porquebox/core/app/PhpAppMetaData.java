...
package org.porquebox.core.app;
...
public class PhpAppMetaData extends ApplicationMetaData {

    public static final AttachmentKey<PhpAppMetaData> ATTACHMENT_KEY = AttachmentKey.create( PhpAppMetaData.class );

    public PhpAppMetaData(String applicationName) {
