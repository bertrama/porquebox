 ...
 *
 */
public class EnvironmentIniParsingProcessor extends AbstractSplitIniParsingProcessor {

    public EnvironmentIniParsingProcessor() {
    ...
    private static final Logger log = Logger.getLogger( "org.porquebox.core.app.env" );
}
