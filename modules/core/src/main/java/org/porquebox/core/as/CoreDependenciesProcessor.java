...
public class CoreDependenciesProcessor implements DeploymentUnitProcessor {
    ...
    private static ModuleIdentifier PORQUEBOX_BOOTSTRAP_ID = ModuleIdentifier.create("org.porquebox.bootstrap");
    private static ModuleIdentifier PORQUEBOX_CORE_ID = ModuleIdentifier.create("org.porquebox.core");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (unit.hasAttachment( PhpAppMetaData.ATTACHMENT_KEY )) {
            //addDependency( moduleSpecification, moduleLoader, PORQUEBOX_BOOTSTRAP_ID );
            addDependency( moduleSpecification, moduleLoader, PORQUEBOX_CORE_ID );
