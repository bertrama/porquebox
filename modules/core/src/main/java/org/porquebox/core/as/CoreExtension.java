...
public class CoreExtension extends AbstractBootstrappableExtension {
    ...
    public void initialize(ExtensionContext context) {
        log.info( "Initializing PorqueBox Core Subsystem" );
        ...
        try {
            ...
            porquebox.printVersionInfo( log );
            // porquebox.verifyPhpVersion( log );
        } catch (IOException e) {
            log.error( "Failed to load porquebox.properties", e );
        }
    }
    ...
    public static final String SUBSYSTEM_NAME = "porquebox-core";
