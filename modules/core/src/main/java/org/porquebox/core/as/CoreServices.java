...
public class CoreServices {
    ...
    public static final ServiceName PORQUEBOX = ServiceName.of("porquebox");
    public static final ServiceName CORE = PORQUEBOX.append("core");
    ...
    public static final ServiceName GLOBAL_PHP                    = RUNTIME.append( "global" );
