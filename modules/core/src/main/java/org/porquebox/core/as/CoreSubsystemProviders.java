...
public class CoreSubsystemProviders {
    ...
    static final DescriptionProvider SUBSYSTEM = new DescriptionProvider() {
        ...
        public ModelNode getModelDescription(Locale locale) {
            ...
            subsystem.get(DESCRIPTION).set(bundle.getString("porquebox-core"));
    ...
    static final DescriptionProvider INJECTOR = new DescriptionProvider() {
        ...
        public ModelNode getModelDescription(Locale locale) {
            ...
            injector.get(DESCRIPTION).set(bundle.getString("porquebox-core"));
    ...
    static final DescriptionProvider SUBSYSTEM_ADD = new DescriptionProvider() {
        ...
        public ModelNode getModelDescription(Locale locale) {
            ...
            operation.get(DESCRIPTION).set(bundle.getString("porquebox-core.add"));
    ...
    static final DescriptionProvider INJECTOR_ADD = new DescriptionProvider() {
        ...
        public ModelNode getModelDescription(Locale locale) {
            ...
            operation.get(OPERATION_NAME).set(ADD);
            operation.get(DESCRIPTION).set(bundle.getString("porquebox-core.injector.add"));
            operation.get(REQUEST_PROPERTIES).setEmptyObject();
            operation.get(REPLY_PROPERTIES).setEmptyObject();
