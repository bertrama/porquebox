...
public class ComponentClass implements ComponentInstantiator {
    ...
    public Object newInstance(QuercusEngine runtime, Object[] initParams, boolean alwaysReload) {
        if (alwaysReload) {
            ...
            synchronized(("ComponentClassLock" + this.className).intern()) {
                ...
                return null; //RuntimeHelper.instantiate(runtime, this.className, initParams);
            }
        } else {
