...
public class DataSourceServices {
    ...
    public static boolean enabled = Boolean.parseBoolean( System.getProperty( "org.porquebox.core.datasource.enabled", "true" ) );
    ...
    public static String jndiName(DeploymentUnit unit, String dsName) {
        return "java:/porquebox/datasources/" + unit.getName() + "/" + dsName;
    }
