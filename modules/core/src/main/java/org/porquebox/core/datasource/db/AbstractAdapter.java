...
public abstract class AbstractAdapter implements Adapter {
    ...
    public AbstractAdapter(String id, String requirePath, String phpDriverClassName, String driverClassName, String dataSourceClassName) {
        this.id = id;
        this.requirePath = requirePath;
        this.phpDriverClassName = phpDriverClassName;
    ...
    @Override
    public String getPhpDriverClassName() {
        return this.phpDriverClassName;
    }
    ...
    private String phpDriverClassName;
