...
import org.porquebox.core.datasource.DataSourceInfoList;
import org.porquebox.core.datasource.DataSourceInfoList.Info;
import org.porquebox.core.datasource.DataSourceInfoListService;
import org.porquebox.core.datasource.DataSourceServices;
import org.porquebox.core.datasource.DataSourceXAVerifierService;
import org.porquebox.core.datasource.DatabaseMetaData;
import org.porquebox.core.datasource.DriverService;
import org.porquebox.core.datasource.JDBCDriverLoadingRuntimeService;
import org.porquebox.core.datasource.db.Adapter;
import org.porquebox.core.datasource.db.H2Adapter;
import org.porquebox.core.datasource.db.MySQLAdapter;
import org.porquebox.core.datasource.db.OracleAdapter;
import org.porquebox.core.datasource.db.PostgresAdapter;
...
public class DatabaseProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        String currentEnv = phpAppMetaData.getEnvironmentName();
        String applicationDir = phpAppMetaData.getRoot().getAbsolutePath();
    ...
    private void installJDBCDriverLoadingRuntime(DeploymentPhaseContext phaseContext) {
        ...
        phaseContext.getServiceTarget().addService( name, service )
                .addDependency( CoreServices.runtimeFactoryName( unit ).append( "lightweight" ), PhpRuntimeFactory.class, service.getRuntimeFactoryInjector() )
    ...
    protected void processDriver(DeploymentPhaseContext phaseContext, Adapter adapter, String applicationDir) throws DeploymentUnitProcessingException {
        ...
        phaseContext.getServiceTarget().addService( name, driverService )
                ...
                .addDependency( DataSourceServices.jdbcDriverLoadingRuntimeName( unit ), QuercusEngine.class, driverService.getRuntimeInjector() )
    ...
    private static final Logger log = Logger.getLogger( "org.porquebox.db" );
