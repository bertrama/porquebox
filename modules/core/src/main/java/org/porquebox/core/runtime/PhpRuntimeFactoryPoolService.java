...
public class PhpRuntimeFactoryPoolService implements Service<PhpRuntimePool>{

    public PhpRuntimeFactoryPoolService(PhpRuntimePool pool) {
        this.pool = pool;
    }
    ...
    private static final Logger log = Logger.getLogger( "org.porquebox.core.runtime.pool" );
