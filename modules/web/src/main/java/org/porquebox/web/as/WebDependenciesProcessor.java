...
public class WebDependenciesProcessor implements DeploymentUnitProcessor {
    ...
    private static ModuleIdentifier PORQUEBOX_WEB_ID = ModuleIdentifier.create("org.porquebox.web");
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (unit.hasAttachment( PhpMetaData.ATTACHMENT_KEY )) {
            addDependency( moduleSpecification, moduleLoader, PORQUEBOX_WEB_ID );
